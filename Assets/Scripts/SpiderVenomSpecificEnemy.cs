...
public class SpiderVenomSpecificEnemy : SpecificEnemy
{
    [SerializeField]
    ...
    public void FireBullet()
    {
        ...
        GameObject bullet2 = Instantiate(tornadoBulletGOPrefab, firingPoint.position, Quaternion.Euler(new Vector3(0,90,0)));
        bullet2.GetComponent<Bullet>().Fire(target.transform);

        GameObject bullet3 = Instantiate(tornadoBulletGOPrefab, firingPoint.position, Quaternion.Euler(new Vector3(0,180,0)));
        bullet3.GetComponent<Bullet>().Fire(target.transform);

        GameObject bullet4 = Instantiate(tornadoBulletGOPrefab, firingPoint.position, Quaternion.Euler(new Vector3(0,270,0)));
